...
public class HTTP_Application implements Runnable{
	...
	public HTTP_Application(Socket r) {
		this.setRequest(r);
	...
	@Override
	public void run() {
		System.out.println("Client "+clientConnection.getInetAddress()+" made new request.");
		try {
			clientConnection.setKeepAlive(true);
			clientConnection.setSoTimeout(10);
			...
			else 
			{
				...
				if(method.equals("GET")) {
					if(path.equals("/")) {		
						...
						out.writeBytes("Date: " + firstRequestTime.toString()+"\r\n");
				...
				else if(method.equals("POST"))
				{
						...
						String contentToAdd = 
								" <tr>\r\n" + 
								"    <td>"+new Date()+"</td>\r\n" + 
								"    <td>"+clientConnection.getInetAddress()+"</td>\r\n" + 
								"	<td>"+message+"</td>\r\n" + 
								"  </tr>";
